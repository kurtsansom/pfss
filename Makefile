...
DEFINES			+= -DTHREADS32			# number of thread to be used in multi-threaded computations
...
DEFINES			+= -DREMOVEMONOPOLE		# removes artificial magnetic monopole from magnetograms
...
#$(DST_DIR)hcSphere.o: ./engine/math/hcSphere.cpp ./engine/math/hcSphere.h
#	$(CXX) $(CXXFLAGS) $(INCPATH) -c -o $(DST_DIR)hcSphere.o ./engine/math/hcSphere.cpp  
#
#$(DST_DIR)hcCircle.o: ./engine/math/hcCircle.cpp ./engine/math/hcCircle.h
#	$(CXX) $(CXXFLAGS) $(INCPATH) -c -o $(DST_DIR)hcCircle.o ./engine/math/hcCircle.cpp  